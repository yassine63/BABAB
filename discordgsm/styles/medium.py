...
class Medium(Style):
    ...
    def embed(self) -> Embed:
        ...
        icon_url = 'https://cdn.discordapp.com/attachments/991815971755008020/1021440477255442452/Frame_16_4.png'
        embed.set_footer(text=f' ✨Trixx✨ {__version__} | {advertisement} | Dernière mise à jour : {last_update}', icon_url=icon_url)
